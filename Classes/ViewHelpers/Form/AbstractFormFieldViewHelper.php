<?php
namespace FoT3\FluidLaravel\ViewHelpers\Form;

/**
 * Abstract Form View Helper. Bundles functionality related to direct property access of objects in other Form
 * ViewHelpers.
 *
...
abstract class AbstractFormFieldViewHelper extends AbstractFormViewHelper
{
    ...
    protected function getNameWithoutPrefix()
    {
        if ($this->isObjectAccessorMode()) {
            ...
            $formObjectName =
                $this->viewHelperVariableContainer->get('TYPO3\Fluid\ViewHelpers\FormViewHelper', 'formObjectName');
    ...
    protected function addAdditionalIdentityPropertiesIfNeeded()
    {
        ...
        for ($i = 1; $i < count($propertySegments); $i++) {
            ...
            $this->viewHelperVariableContainer->addOrUpdate('TYPO3\Fluid\ViewHelpers\FormViewHelper',
    ...
    /**
     * Internal method which checks if we should evaluate a domain object or just output arguments['name'] and
     * arguments['value']
     *
